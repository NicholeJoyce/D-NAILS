...
<head>
  ...
  <title>RWS Trucking (contact)</title>
      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            <h2>Contact</h2>
            <p>If you have concerns, suggestions on how we can improve, or inquiries you may send us you message below, Thank you!</p>
          ...
          <div class="col-lg-9">
            <form action="send.php" method="post">
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject or the offered service you are interested in" required>
              </div>
              <div class="form-group mt-3">
